...
const signup = async (req, res) => {
  try {
    ...
    // ✅ thanks to toJSON, password is stripped & userType is readable
    ...
    sendResponse(res, StatusCodes.CREATED, "Signed up successfully", { user: userObj });
  } catch (error) {
...
const login = async (req, res) => {
  try {
    ...
    sendResponse(res, StatusCodes.OK, "Logged in successfully", { user: userObj });
  } catch (error) {
    res.status(StatusCodes.BAD_REQUEST).json({ error: error.message });
  }
};
